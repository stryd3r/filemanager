				...
				[
					...
					function($scope, $rootScope, APPCONST, srv, modalSrv, $state,
						...
						function init(object) {
							...
							/*
							 * address : object.pacientDetail.address, zipCode :
							 * object.pacientDetail.zipCode, phone :
							 * object.pacientDetail.phone, age : object.pacientDetail.age, sex :
							 * object.pacientDetail.sex, consultations : object.consultations
							 */
							};
